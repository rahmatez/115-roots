                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.blogs.update', [$blog]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="excerpt" id="excerpt" cols="30" rows="5" maxlength="160" placeholder="max: 160 character">{{ old('excerpt', $blog->excerpt) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                <label for="meta_title" class="col-sm-2 col-form-label">Meta Title (SEO)</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="meta_title" value="{{ old('meta_title', $blog->meta_title) }}" id="meta_title">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                                <label for="meta_description" class="col-sm-2 col-form-label">Meta Description</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="meta_description" id="meta_description" rows="2">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                </div>
                            </div>
